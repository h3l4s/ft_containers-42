...
void test_construtor(std::ostream &stream1)
{
  ...
  stream1 << "The contents of fistdh are:";
...
void test_iterator(std::ostream &stream1)
{
 ...
 void test_operator(std::ostream &stream1)  
{
...
void test_size(std::ostream &stream1)
{
    // size
 ...
 void max_size(std::ostream &stream1)
{
  ft::vector<int> myvector;
...
void resize(std::ostream &stream1)
{
  ft::vector<int> myvector;
...
void  capacity(std::ostream &stream1)
{
  ft::vector<int> myvector;
...
void  empty(std::ostream &stream1)
{
  ft::vector<int> myvector;
  int sum (0);
...
void  reserve(std::ostream &stream1)
{
    ft::vector<int> foo;
 ...
 void   operator_croche(std::ostream &stream1)
{
...
void  front(std::ostream &stream1)
{
  ft::vector<int> myvector;
...
int test_assign (std::ostream &stream1)
{
	ft::vector<int> first;
...
int push_back(std::ostream &stream1)
{
  ft::vector<int> myvector;
...
int pop_back(std::ostream &stream1)
{
  ft::vector<int> myvector;
  int sum (0);
  ...
  int	insert(std::ostream &stream1)
{
